...
function getCarHonda(caring) {
    const honda1 = caring.find((car) => car.car_make ===  "Honda");

    const sentence = `This is a ${honda1.car_make} ${honda1.car_model} from ${honda1.car_year}`
    console.log(sentence)
}
getCarHonda(inventory)


function sortCarInventoryByYear(caring) {
    const result = caring.sort((a,b) =>(a.car_year < b.car_year ? -1 : 1))
    console.log(result)
